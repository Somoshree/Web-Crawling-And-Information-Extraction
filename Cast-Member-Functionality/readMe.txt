...
SUBJECT: CL-II ASSIGNMENT 9 (TASK 2)
...
9. WHEN ENTERING THE CAST NAME WHOSE DETAILS NEED TO DISPLAYED ON CONSOLE, ENTER ONLY THE CAST NAME AND NOT THE NAME OF THE CHARACTER, I.E. FOR A CAST/CREW MEMBER DISPLAYED AS 'X AS Y', ENTER ONLY X IN ORDER TO QUERY DETAILS OF THE CAST MEMBER X. ALSO THE NAME OF THE CAST MEMBER MUST EXACTLY MATCH THE NAME AS DISPLAYED, BUT USER HAS THE DISCRETION TO ENTER THIS NAME IN A CASE-INSENSITIVE MANNER AS LONG AS THE NAME MATCHES WITH THE ORIGINAL.

10. FINALLY THE CORRESPONDING VALUE FOR THE FIELD NAME IS DISPLAYED ONTO THE CONSOLE. ALSO, A FILE NAMED AS 'result_log.txt' GETS FORMED IN THE SAME FOLDER AS THE CODE FILES WHERE ALL THE LOGS OF THE QUERIES RELATED ONLY TO MOVIES ARE STORED. THE LOGS CORRESPONDING TO CAST AND CREW MEMBERS ARE NOT STORED.
